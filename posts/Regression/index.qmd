...
ms_att <- ggplot(empl.att) +
 ...
 theme_minimal() +
 theme(plot.title = element_text(size = 14L, face = "italic", hjust = 0.5))
...
grid.arrange(ot_att, jbs_att, yslp_att, mi_att, jl_att, dep_att, yac_att, ms_att, ag_att, ge_att, dh_att, ncol = 3, nrow = 4, top= textGrob("Attrition", gp=gpar(fontsize=28,font=8)))
