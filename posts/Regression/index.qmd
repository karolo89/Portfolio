...
```{r}
employee.att <- read.csv("https://github.com/karolo89/Portfolio/files/9768858/IBM-HR-Employee-Attrition.csv")
```
...
```{r, warning=FALSE, fig.width = 35, fig.height = 25}
...
ms_att <- ggplot(empl.att) +
 ...
 direction = 1) +
 labs(title = "By Marital Status", y= " ", x= " ") +
 theme_minimal() +
 theme(plot.title = element_text(size = 24L, face = "italic", hjust = 0.5),
...
grid.arrange( ms_att, ag_att, ge_att, ncol = 3, nrow = 4, top= textGrob("Attrition", gp=gpar(fontsize=58,font=8)))
```
...
yac_att <- ggplot(empl.att) +
 ...
 scale_fill_brewer(palette = "Dark2", 
 direction = 1) +
 labs(title = "By Years at the Company", y= " ", x= " ") +
 theme_minimal() +
 theme(plot.title = element_text(size = 24L, 
 face = "italic", hjust = 0.5),
       axis.text.x = element_text(color = "grey20", size = 20, face = "plain"),
...
mi_att<- ggplot(empl.att) +
 ...
 scale_fill_brewer(palette = "Dark2", 
 direction = 1) +
 labs(title = "By Montly Income", y= " ", x= " ") +
 theme_minimal() +
 theme(plot.title = element_text(size = 24L, face = "italic", hjust = 0.5),
       axis.text.x = element_text(color = "grey20", size = 20, face = "plain"),
       axis.text.y = element_text(color = "grey20", size = 20, face = "plain"))
...
```{r, warning=FALSE, fig.width = 35, fig.height = 25}
grid.arrange(ot_att, jbs_att, yslp_att, mi_att, jl_att, dep_att, yac_att, dh_att, ncol = 3, nrow = 3, top= textGrob("Attrition", gp=gpar(fontsize=58,font=8)))
